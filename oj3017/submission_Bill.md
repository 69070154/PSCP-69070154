...
```text
input: จำนวนเงินค่าอาหารแล้วน้ำ เป็นจำนวนเต็ม
output: ราคาชำระเงินรวมค่าบริการและvat7% โดยมีทศนิยม 2 ต่ำแหน่ง
constraints: input เป็น เป็นจำนวนเต็ม แล้วoutputมาเป็นเป็นจำนวนจริงโดยต้องมีทศนิยม 2 ต่ำแหน่ง
```
...
```text
step 1: input จำนวนเต็มเข้าไป
step 2:ใช้สูตรคณิต หาร้อยละของบริการ 10 % จากค่า input
step 3:รวม ค่าบริการ 10% กับค่า ที่เรา input ไป
step 4: หาร้อยละของค่า vat 7% จาก ผลรวมของ step3
step5:เอา ค่าบริการ 10% ค่า vat7% และ ค่า input มารวมกัน
step 6: printผลรวม step 5 ออกมา แล้วทำให้เป็นทศนิยม 2 ต่ำแหน่ง
```
...
```text
วิธีสุดท้ายที่ใช้จริง เหมือนกับแผนแรก เลย แต่มีสิ่งที่เพิ่มเข้ามา คือ max min เพราะโจทย์กำหนดว่าค่าบริการ 10% คิดอย่างน้อย 50 และสูงสุด 1000 ทำให้เราต้องใช้ max min เพื่อทำให้ เลข ที่ input ต้องหาร้อยละ แล้วถ้าไม่ถึง 50 ก็ จะ50 จาก max แล้วถ้าหาร้อยละ แล้วเกิน 1000 min ก็จะทำให้ที่เกินยังไงก็เป็น 1000เท่านั้น
```
...
```text
เพราะอยากให้เห็นไว้ ค่าบริการเกิน 1000 ก็จะเป็นค่าบริการ 1000 เท่านั้น แต่ vat สามารถเกินได้
```
...
```text
เพราะถ้าเราลองใส่ ค่า 0 ไปก็จะเห็นได้ชัดว่า ตัวขอว max 50 ก็ทำงาน เพราะโจทย์กำหนดให้ ค่าบริการที่เราใช้งานอย่างน้อยต้อง 50 ทำให้เห็นได้ชัดว่า แม้เราจะเสีย 0 บาทก็ต้องเสียค่าบริการอย่างน้อย 50
```
...
```text
เนื่องจากใน input เขาบอกให้เป็นจำนวนเต็มเราเลยใส่ติดลบเข้าไปได้ ถ้าตามความจริงเราไปใช้บริการเงินเราจะติดลบได้ไง แต่ก็ทำให้เห็นว่า เราก็ยังการคำนวณเหมือนแค่ทำให้มันเป็นลบ แล้วค่าบริการก็ยังอย่างน้อย 50 อยู่ดี
```
