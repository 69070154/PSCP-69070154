...
```text
Input:
รับตัวอักษรภาษาอังกฤษยาว 5 ตัว
Output:
แสดงผลภาษาอังกฤษโดยทำให้เป็นตัวเล็กทั้งหมดและกลับด้าน
Constraints:
ฉันควรจะ input ให้ ยาว 5 ตัว พอดี เพราะ โจทย์กำหนดมาแล้วต้องทำให้ input   5 ตัว พอดีไม่ขาดไม่เกิน
```
...
```text
Step1:รับค่าstring ให้ได้ก่อน
Step2:ให้ตัวของString print ออกมา
Step3:ใช้ slicing ใน print โดยให้ start stop เป็น 0 แล้ว step เป็น -1
Step4:ใช้คำสั่ง .lower ใน print ต่อเพื่อทำให้ตัวอักษรเป็นตัวเล็ก
```
...
```text
เหมือนแผนแรก เพราะ เรารับค่า string มา แล้วเอามาprint แล้วใช้ slicing เพื่อนทำให้ตัวอักษรนับจากหลังมาหน้า แล้วปิดท้าย ด้วย .lower เพื่อทำให้ค่าที่ input ไม่ว่าจะตัวใหญ่หรือเล็ก ก็จะเป็นตัวเล็กเสมอ
```
...
```text
นี้คือ testcase ที่เอาไว้เช็คความถูกต้องของ code ที่เขียนไป
```
...
```text
ตัวเครื่องหมาย ก็สามารถเป็น string แต่พวกเครื่องหมายไม่มีตัวเล็ก
```
...
```text
เพราะเคสนี้แสดงให้เห็นว่าเราinput ตัวอักษรเกิน 5 ตัว แต่ output ที่่ออกมา ก็เกิน  5 ตัวไม่ได้จำกัดตัวอักษร
```
...
```text
ช่วยบอกว่าทำไงถึงจะสามารถกลับตัวอักษรได้
```

คุณยังทำอะไรด้วยตนเอง

```text
ฉันเขียน code ทดสอบแล้วส่ง oj ด้วยตนเองทั้งหมด
```
